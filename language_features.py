...
evidence_list = ["evidence", "show", "shows", "say", "says", "state", "states", "according to", "showed", "stated", "according"]
...
def read_macros():
    macros=[]
    macro_files=["lexicons/argument_lexicons/modals.tff","lexicons/argument_lexicons/spoken.tff","lexicons/argument_lexicons/wordclasses.tff","lexicons/argument_lexicons/pronoun.tff","lexicons/argument_lexicons/intensifiers.tff"]
...
def text_to_features(debate_text):
    ...
    for text in debate_text:
        ...
        feature_array.append(arg_lexicon_check(text,arg_lex_folder+"assessments.tff"))
        ...
        feature_array.append(arg_lexicon_check(text,arg_lex_folder+"generalization.tff"))
        feature_array.append(arg_lexicon_check(text,arg_lex_folder+"structure.tff"))
        feature_array.append(arg_lexicon_check(text,arg_lex_folder+"conditionals.tff"))
        feature_array.append(arg_lexicon_check(text,arg_lex_folder+"inconsistency.tff"))
        feature_array.append(arg_lexicon_check(text,arg_lex_folder+"possibility.tff"))
        ...
        feature_array.append(arg_lexicon_check(text,arg_lex_folder+"inyourshoes.tff"))
        feature_array.append(arg_lexicon_check(text,arg_lex_folder+"rhetoricalquestion.tff"))
